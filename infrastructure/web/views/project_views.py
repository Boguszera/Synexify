...
def project_create(request):
    if request.method == "POST":
        ...
        try:
            container.project_service.create_project(name=name, description=description, user=domain_user)
...
def project_detail(request, pk):
    ...
    return render(
        request, "web/projects/dashboard.html", {"project": project, "sprints": sprints, "backlog": backlog_tasks}
    )
