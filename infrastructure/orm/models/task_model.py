...
class TaskModel(models.Model):
    ...
    sprint = models.ForeignKey(
        "orm.SprintModel", on_delete=models.SET_NULL, related_name="tasks", null=True, blank=True
    )
    project = models.ForeignKey(
        "orm.ProjectModel", on_delete=models.CASCADE, related_name="tasks", null=True, blank=True
    )
